...
export default function ProductsLoading() {
  return (
    <>
      {/* Header with Add Button - EXACT same as ProductsTab */}
      ...
      {/* EXACT same wrapper as ProductsTable */}
            ...
            <Table className="table-fixed">
              <TableHeader className="sticky top-0 z-10 bg-background">
                <TableRow className="hover:bg-muted bg-background">
                  <TableHead className="h-11" style={{ width: '40px' }}>
                    <div className="h-4 w-4 bg-muted animate-pulse rounded" />
                  </TableHead>
                  <TableHead className="h-11" style={{ width: '300px' }}>Product</TableHead>
                  <TableHead className="h-11" style={{ width: '200px' }}>Pricing</TableHead>
                  <TableHead className="h-11" style={{ width: '100px' }}>Status</TableHead>
                  <TableHead className="h-11" style={{ width: '120px' }}>Created</TableHead>
                  <TableHead className="h-11" style={{ width: '120px' }}>Updated</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {/* EXACT same skeleton rows as ProductsTable isLoading state */}
                {[...Array(5)].map((_, i) => (
