...
/**
 * Create Folder Dialog for Contracts
 *
 * Modal dialog for creating new contract folders with:
 * - Name input
 * - Color selection (optional preset colors)
 * - Folder preview showing selected color
 *
 * Cloned from email templates create-folder-dialog pattern.
 *
 * SOURCE OF TRUTH KEYWORDS: CreateContractFolderDialog
 */
...
/**
 * Predefined color options for contract folders
 * Curated palette matching the email templates folder colors
 */
const FOLDER_COLORS = [
...
export function CreateFolderDialog({
  ...
  /**
   * Handle form submission — validates name and calls onCreate
   */
      ...
      <DialogContent className="sm:max-w-md">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Create a folder to organize your contracts.</DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="contract-folder-name">Folder Name</Label>
              <Input
