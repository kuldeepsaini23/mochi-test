/**
 * Subscription Detail Loading Skeleton
 *
 * Matches the subscription detail layout: hero stat area, items,
 * subscription info, customer, summary, and payment history.
 * Single column, max-w-3xl — same as transaction detail skeleton.
 *
 * SOURCE OF TRUTH KEYWORDS: SubscriptionDetailLoading
 */
