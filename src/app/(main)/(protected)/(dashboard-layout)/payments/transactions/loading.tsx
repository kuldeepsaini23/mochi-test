...
export default function TransactionsLoading() {
  return (
    <>
      {/* Header - EXACT same as TransactionsTab */}
      ...
      {/* EXACT same wrapper as TransactionsTable */}
            ...
            <Table className="table-fixed">
              <TableHeader className="sticky top-0 z-10 bg-background">
                <TableRow className="hover:bg-muted bg-background">
                  <TableHead className="h-11" style={{ width: '240px' }}>Customer</TableHead>
                  <TableHead className="h-11" style={{ width: '200px' }}>Product</TableHead>
                  <TableHead className="h-11" style={{ width: '140px' }}>Amount</TableHead>
                  <TableHead className="h-11" style={{ width: '120px' }}>Status</TableHead>
                  <TableHead className="h-11" style={{ width: '120px' }}>Progress</TableHead>
                  <TableHead className="h-11" style={{ width: '100px' }}>Date</TableHead>
                  <TableHead className="h-11" style={{ width: '40px' }}></TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {/* EXACT same skeleton rows as TransactionsTable isLoading state */}
                {[...Array(5)].map((_, i) => (
