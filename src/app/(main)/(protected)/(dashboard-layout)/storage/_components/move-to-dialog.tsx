 ...
 *
 * Clean, minimal modal for moving files to folders.
 * Uses the same folder design and colors as FolderCard.
 */
...
// ============================================================================
// FOLDER ICON - Same as FolderCard
// ============================================================================

/**
 * Folder icon using the exact same SVG as FolderCard.
 * Default color matches FolderCard's default (#3f3f46).
 */
...
function FolderRow({
  ...
  return (
    ...
    >
      ...
      {/* File count */}
      {!isCurrent && folder._count.files > 0 && (
...
function FolderNode({
  ...
  const { data: children, isLoading } = trpc.storage.listFolders.useQuery(
...
export function MoveToDialog({
  ...
  const { data: rootFolders, isLoading } = trpc.storage.listFolders.useQuery(
        ...
        <ScrollArea className="h-[320px] px-2">
          <div className="space-y-0.5 pb-2">
            ...
            >
              ...
              <span className="text-sm flex-1">My Files</span>
              {isRootCurrent && (
