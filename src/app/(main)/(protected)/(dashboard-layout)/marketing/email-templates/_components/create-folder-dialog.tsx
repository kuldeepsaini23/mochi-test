 ...
 *
 * Modal dialog for creating new email template folders with:
 * - Name input
 * - Color selection (optional)
 * - Preview of folder appearance
 *
 * SOURCE OF TRUTH KEYWORDS: CreateEmailTemplateFolderDialog
 */
      ...
      <DialogContent className="sm:max-w-md">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Create a folder to organize your email templates.</DialogDescription>
          </DialogHeader>
