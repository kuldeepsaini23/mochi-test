/**
 * ============================================================================
 * ICON LIBRARY - Icon Definitions (~100 Icons)
 * ============================================================================
 *
 * A curated collection of ~100 commonly used icons.
 ...
 * - Files: file, folder, document, etc.
 * - Commerce: cart, credit card, etc.
 * - Social: share, like, user, etc.
 * - Misc: settings, search, etc.
 *
 * USAGE:
...
export const MinusIcon = createIcon('MinusIcon', <line x1="5" y1="12" x2="19" y2="12" />)
...
export const StopIcon = createIcon('StopIcon', <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />)
...
export const SquareIcon = createIcon('SquareIcon', <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />)

export const CircleIcon = createIcon('CircleIcon', <circle cx="12" cy="12" r="10" />)

export const TriangleIcon = createIcon('TriangleIcon', <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" />)

export const OctagonIcon = createIcon('OctagonIcon', <polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2" />)

export const HexagonIcon = createIcon('HexagonIcon', <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" />)
