 ...
 * ============================================================================
 *
 * Configuration form for the "Add Tag" action.
 * Reuses the TagsInput component from the leads page for a rich
 * search/select/create experience instead of a basic dropdown.
 *
 * Supports multiple tags per action node.
 *
 * SOURCE OF TRUTH: AddTagActionConfig
 */
...
import type { AddTagActionConfig as AddTagConfig } from '../../../_lib/types'
...
interface ActionAddTagConfigProps {
  config: AddTagConfig
...
export function ActionAddTagConfig({
  config,
  onChange,
  errors,
}: ActionAddTagConfigProps) {
