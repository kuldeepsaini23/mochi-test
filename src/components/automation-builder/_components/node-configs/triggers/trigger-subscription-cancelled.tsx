/**
 * ============================================================================
 * SUBSCRIPTION CANCELLED TRIGGER CONFIG
 * ============================================================================
 *
 * Configuration form for the "Subscription Cancelled" trigger.
 * Fires when a subscription is cancelled or churns (customer or merchant initiated).
 *
 * Primary filter: price ID (most specific — identifies exactly which price was cancelled).
...
import type { SubscriptionCancelledTriggerConfig as SubscriptionCancelledConfig } from '../../../_lib/types'
...
interface TriggerSubscriptionCancelledConfigProps {
  config: SubscriptionCancelledConfig
  onChange: (config: SubscriptionCancelledConfig) => void
...
export function TriggerSubscriptionCancelledConfig({
  config,
  onChange,
  errors,
}: TriggerSubscriptionCancelledConfigProps) {
   ...
   * ONE_TIME products can't be cancelled — they're not subscriptions.
   */
   ...
   * Price ID is the most specific filter — it identifies exactly which price was cancelled.
   */
