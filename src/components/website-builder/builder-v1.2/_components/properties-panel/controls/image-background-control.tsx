/**
 * ========================================
 * IMAGE BACKGROUND CONTROL - Properties Panel
 * ========================================
 *
 * Provides two ways for users to set a background image:
 ...
 *
 * Used for frame/container background images.
 */
...
/**
 * Source type determines how the user can provide a background image
...
export function ImageBackgroundControl({
  label,
  value,
  onChange,
  hasMobileOverride,
  ...
  return (
    <div className="space-y-2">
      ...
      {/* Frame label for context */}
      <p className="text-xs text-muted-foreground/60">Frame</p>
